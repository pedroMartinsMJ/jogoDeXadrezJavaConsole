...
public class ChessMatch {
    ...
    //retorna uma matriz de peças de xadrez correspondete a partida
    ...
    public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition){
        ...
        if (testCheck(currentPlayer)){
            ...
            throw new ChessException("vc não pode se colocar em check");
        }

        ChessPiece movedPiece = (ChessPiece)board.piece(target);

        //especialmovimento promoção
        promoted = null;
    ...
    public ChessPiece replacePromotedPiece(String type) {
        if (promoted == null){
            throw  new IllegalStateException("não a peça para ser promovida ERRO");
        }
    ...
    private Piece makeMove(Position source, Position target){
        ...
        //jogada especial castling kingsidec rook
        ...
        //jogada especial castling queenside rook
        if (p instanceof King && target.getColumn() == source.getColumn() - 2){
    ...
    private void validateSourcePosition(Position position){
        ...
        if (!board.piece(position).isThereAnyPossibleMove()) {
            throw  new ChessException("não nenhum movimento possivel para essa peça...");
        }
    }
    ...
    private ChessPiece king(Color color){
        ...
        throw new IllegalStateException("não existe erro da cor " + color +" ERRO");
    }
